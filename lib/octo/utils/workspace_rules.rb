...
module Octo
  module Utils
    ...
    module WorkspaceRules
      ...
      # Find all sub-project .octorules in immediate subdirectories.
      ...
      def self.find_sub_projects(dir)
        Dir.glob(File.join(dir, "*", ".octorules")).sort.filter_map do |rules_path|
          ...
          {
            sub_name: sub_name,
            relative_path: "#{sub_name}/.octorules",
            content: content,
            summary: summary
          }
        end
