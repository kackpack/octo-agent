...
require "octo/ui2/layout_manager"
...
#   scrollback.
RSpec.describe Octo::UI2::LayoutManager, "#paint_new_lines scroll / commit accounting" do
  ...
  def build_manager(width: 80, height: 10)
    lm = Octo::UI2::LayoutManager.new(input_area: stub_input_area)
