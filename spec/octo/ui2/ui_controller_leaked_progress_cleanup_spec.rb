...
require "octo/ui2/ui_controller"
require "octo/ui2/progress_handle"
...
RSpec.describe Octo::UI2::UIController, "#set_idle_status closes leaked legacy progress handles" do
  ...
  def build_skeleton_controller
    ctrl = Octo::UI2::UIController.allocate
  ...
  it "finishes every legacy ProgressHandle that is still running" do
    ...
    retrying = Octo::UI2::ProgressHandle.new(
      owner: owner,
    ...
    idle = Octo::UI2::ProgressHandle.new(
      owner: owner,
  ...
  it "ignores handles that have already been finished (no double-finish)" do
    ...
    already_done = Octo::UI2::ProgressHandle.new(owner: owner, message: "x", style: :quiet)
    already_done.start
    already_done.finish
