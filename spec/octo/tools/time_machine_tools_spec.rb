...
RSpec.describe "Time Machine Tools" do
  ...
  describe Octo::Tools::UndoTask do
  ...
  describe Octo::Tools::RedoTask do
    let(:tool) { described_class.new }
  ...
  describe Octo::Tools::ListTasks do
    let(:tool) { described_class.new }
