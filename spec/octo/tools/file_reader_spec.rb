...
RSpec.describe Octo::Tools::FileReader do
    ...
    context "when reading binary files" do
      ...
      it "returns a text result when parser succeeds on a PDF" do
        ...
        Dir.mktmpdir do |dir|
          ...
          fake_ref = Octo::Utils::FileProcessor::FileRef.new(
            name: "real.pdf", type: :pdf,
            original_path: pdf_file, preview_path: preview_path
          )
          allow(Octo::Utils::FileProcessor).to receive(:process_path).and_return(fake_ref)
