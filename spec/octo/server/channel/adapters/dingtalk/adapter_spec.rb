...
require "spec_helper"
require "octo/server/channel/adapters/dingtalk/adapter"
require "octo/server/channel/adapters/dingtalk/api_client"

RSpec.describe Octo::Channel::Adapters::DingTalk::Adapter do
  let(:config) do
    {
      client_id:     "cid",
  ...
  describe "#send_file (C-5597)" do
    ...
    it "sends [DingTalk System] error text and returns ok:false for non-whitelist files" do
      ...
      Octo::Channel::Adapters::DingTalk::ApiClient::SUPPORTED_FILE_EXTS.each do |ext|
