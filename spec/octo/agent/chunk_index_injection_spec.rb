...
RSpec.describe "chunk index injection and topics" do
  ...
  def build_agent(messages)
    history = Octo::MessageHistory.new(messages)

    agent_class = Class.new do
      include Octo::Agent::SessionSerializer
  ...
  describe "save_compressed_chunk excludes compressed_summary messages" do
    ...
    before { stub_const("Octo::SessionManager::SESSIONS_DIR", sessions_dir) }
  ...
  describe Octo::MessageHistory do
